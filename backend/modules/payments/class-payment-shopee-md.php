...
if (!class_exists('Shopee_Minta_Dana')){

    class Shopee_Minta_Dana extends Payment_Template
    {
        public $id = 'shopee_md';
        ...
        public function default_settings()
        {
            ...
            if ( !isset($payment_data[$this->id]) || $payment_data[$this->id] == null ) { // Empty and Not Isset
                ...
                $payment_data[$this->id] = array(
                    'name'              => 'Shoppe Minta Dana',
                    'description'       => 'Terima Pembayaran Melalui Shopee',
                    'logo'              => LSDC_URL . 'assets/images/payment/qris.png',
                    'group'             => 'e-money',
                    'group_name'        => 'E-Money',
                    'docs'              => 'google.com',
                    'template_class'    => 'Shopee_Minta_Dana',
                    'shopee_barcode'    => 'https://i.ibb.co/z2031gJ/QRIS-LSDPlugins.png',
                    'shopee_link'       => 'https://i.ibb.co/z2031gJ/QRIS-LSDPlugins.png',
                    'shopee_owner'      => 'LSD Plugins',
        ...
        public function manage( $payment_id )
        {
            ...
            <div id="<?php echo $this->id; ?>_content" class="payment-editor d-hide">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <?php if (current_user_can('upload_files')): ?>
                                <img style="width:150px;margin-bottom:15px;" src="<?php echo ($settings['logo'] == '') ? $logo_empty : esc_url($settings['logo']); ?>"/>
                                <input class="form-input" type="text" style="display:none;" name="logo" value="<?php echo ($settings['logo'] == '') ? $logo_empty : esc_url($settings['logo']); ?>" >
                        ...
                        <div class="form-group">
                            ...
                            <?php if (current_user_can('upload_files')): ?>
                                ...
                                <input class="form-input" type="text" style="display:none;" name="qr_image" value="<?php echo ($settings['qr_image'] == '') ? $logo_empty : esc_url($settings['qr_image']); ?>" >
                         ...
                         */
                        do_action('lsdcommerce/admin/payment/shopee_md');
                        ?>
                ...
                <div class="panel-footer">
                    <button class="btn btn-primary btn-block lsdc-payment-save" id="<?php echo $this->id; ?>_payment"><?php _e('Save', 'lsdcommerce');?></button>
                </div>
            </div>
        <?php
        }
    ...
    // Payment::register("shopee_md", new Shopee_Minta_Dana());
