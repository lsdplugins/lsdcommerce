...
class RajaOngkirStarter extends Shipping_Template
{
    protected $id = 'rajaongkir_starter';
    protected $name = 'RajaOngkir Starter';
    protected $type = 'API Pengiriman';
...
Shipping::register("rajaongkir-starter", new RajaOngkirStarter());
?>